...
void autonomous() {
    ...
    chassis.turnToPoint(a*17, b*12, 700);
    chassis.moveToPoint(a*17, b*12, 4000, {.maxSpeed = 50});
    pros::delay(3000);
    ...
    chassis.turnToPoint(a*13, b*-18, 700);
    chassis.moveToPoint(a*13, b*-18, 1000);
