...
void autonomous() {
    ...
    pros::delay(200);
    convState(0, 0); // intake
    pros::delay(2700);
    convState(0, -1); // stop
    chassis.turnToPoint(a*23.7, b*33, 700);
    pros::delay(200);
    scraper.set_value(false);
    ...
    // the rest of your original auton sequence...
    // (kept unchanged to preserve logic; they already use convState to control convAuton)
